...
<div class="container">
  ...
  <form name="form1" action="" method="post">
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="email" placeholder="example@example.com" name="userId">
    </div>
    <div class="form-group">
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $pwd = trim($_POST['userPass']);
        $fname = trim($_POST['fname']);
        $lname = trim($_POST['lname']);
        $dob = trim($_POST['dob']);
        $country = trim($_POST['country']);

        if(empty($uid) || empty($pwd) || empty($fname) || empty($lname) || empty($dob) || empty($country) )
        {
            echo "Please fill all the details"; 
        }
        else
        {
            register($uid, $pwd, $fname, $lname, $dob, $country);
        }
    }
